...
static struct texdef_s {
    int id;
    const char* filename;
} const texdefs[] = {{0, "gfx/sheep.png"},
...
static struct tiletexdef_s {
    int id;
    const char* filename;
} const tiletexdefs[] = {
    {0, "gfx/walls/brickwall01.png"}, {1, "gfx/walls/brickwall02.png"},
    {2, "gfx/walls/brickwall03.png"}, {3, "gfx/walls/brickwall04.png"},
    {4, "gfx/walls/brickwall05.png"}, {5, "gfx/walls/dirtwall01.png"},
...
} const spritedefs[] = {{TEX_ULTIMATEMAN, SPR_ULTIMATEMAN, 64, 64, 1, 1},
                        {TEX_SLIME, SPR_SLIME, 64, 64, 4, 4},
                        {TEX_VIEW_KNIFE, SPR_VIEW_KNIFE, 64, 64, 4, 1}};

typedef enum weapons_e { WEP_KNIFE = 0 } WeaponType;
static struct weapondef_s {
    WeaponType weaponType;
    SpriteId spriteId;
    double maxDistance, damage, frequency;
} const weapondefs[] = {{WEP_KNIFE, SPR_VIEW_KNIFE, 1, 1, 0.25}};

typedef enum monster_type_e { MT_theUltimateMan, MT_slime } MonsterType;
static struct monsterdef_s {
    MonsterType type;
    SpriteId spriteId;
    double speed, meleeAttackDistance, meleeDamage, meleeFrequency;
} const monsterdefs[] = {{MT_theUltimateMan, SPR_ULTIMATEMAN, 0.01, 1, 1, 1},
